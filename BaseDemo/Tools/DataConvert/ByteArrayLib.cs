...
namespace Tools.DataConvert {
    ...
    public class ByteArrayLib {
        ...
        #endregion 将Short及UShort类型转换成字节数组
        ...
        #endregion 将Short及UShort数组转换成字节数组
        ...
        #endregion 将Int及UInt及Float及Double类型转换成字节数组
        ...
        #endregion 将Int及UInt及Float及Double数组转换成字节数组
        ...
        #endregion 将Long及ULong类型转换成字节数组
        ...
        #endregion 将Long及ULong数组转换成字节数组
